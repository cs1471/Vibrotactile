...
function makeWeightedTrainingStimuli(prevAcc, prevStimuli, levelTrain)
   ...
   weightedLevel = [repmat(f,1,6) repmat(f2,1,6), repmat(f1(fMinInd(1)),1,6);
                    repmat(f2,1,6) repmat(f,1,6), repmat(f1(22-fMinInd(1)),1,6)];
   ...
   save ('trainingStimuliWeight.mat', 'trainingStimuli', 'levelTrain')
