...
if exist(['./history/SUBJ' number 'training.mat'], 'file')
    ...
    fprintf(['Subject has been here before ' ])
else
    fprintf('Subject has not been entered before')
end
pause(2)
...
exptdesign.numSessions = 12;              % number of blocks (160 trials each) to complete this training session

% if/else statement to set the number of trials for the level
exptdesign.numTrialsPerSession = 6;    % number of trials per block
...
VToddballExperiment(name,exptdesign);