...
figLine['data']     = [traceACC_line[0], traceACC_line[1], traceACC_line[2], traceACC_line[3], traceACC_line[4],
                       traceACC_line[5], traceACC_line[6], traceACC_line[7], traceACC_line[8], traceACC_line[9], traceACC_line_O]
figMorph['data']    = [traceACC_morph[0], traceACC_morph[1], traceACC_morph[2], traceACC_morph[3], traceACC_morph[4],
                       traceACC_morph[5], traceACC_morph[6], traceACC_morph[7], traceACC_morph[8], traceACC_morph[9], traceACC_morph_O]
...
#py.image.save_as(figOverall, fileDirectory + "Group_ACC_RT_EEG.jpeg")
#py.image.save_as(figMorph, fileDirectory + "Group_ACC_RT_EEG_byMorph.jpeg")
#py.image.save_as(figLine, fileDirectory + "Group_ACC_RT_EEG_byLine.jpeg")
