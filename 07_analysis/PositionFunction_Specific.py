        ...
        for iSubject in range(len(accuracy)):
            for iBlock in range(accuracy[iSubject].size):
                ...
                for iTrial in range(accuracy[iSubject][0,iBlock].size):
                    if iSubject == 2 or iSubject == 3 or iSubject == 4:
                    ...
                    if self.oneChanDiff_top(pos1, pos2):
                        ...
                        print("There is something wrong with your parsing function in the specific position base class_ACC")
                        print("Here are the positions causing issues: ")
                        print(pos1, pos2)
            ...
            for iBlock in range(RT[iSubject].size):
                ...
                for iTrial in range(RT[iSubject][0,iBlock].size):
                    ...
                    if self.oneChanDiff_top(pos1, pos2) == True:
                        ...
                        print("There is something wrong with your parsing function in the specific position base class_RT")
                        print("Here are the positions causing issues: ")
                        print(pos1, pos2)
